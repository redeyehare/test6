...
/** @type {string} */
const CACHE_VERSION = '1765550985|20837828653';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["test.html","test.js","test.offline.html","test.icon.png","test.apple-touch-icon.png","test.audio.worklet.js","test.audio.position.worklet.js","pako_inflate.min.js"];

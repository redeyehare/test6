...
/** @type {string} */
const CACHE_VERSION = '1765868023|220783458';
/** @type {string} */
const CACHE_PREFIX = 'test-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'indext.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["indext.html","indext.js","indext.offline.html","indext.icon.png","indext.apple-touch-icon.png","indext.audio.worklet.js","indext.audio.position.worklet.js","pako_inflate.min.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["indext.wasm","indext.pck"];
